package smartsuite.app.bp.edu.repository;
...
public class EduRepository {
	...
	/** The namespace. */
	/*NAMESPACE*/
	private static final String NAMESPACE = "edu.";
	...
	public List<Map<String, Object>> findListRegReq(Map searchParam) {
		return sqlSession.selectList(NAMESPACE + "findListRegReq", searchParam);
	}
	
	
	public List<Map<String, Object>> findListItemCat(Map searchParam) {
		return sqlSession.selectList(NAMESPACE + "findListItemCat", searchParam);
	}
